...
echo "$IP ${DIR_NAME}.thm" >> /etc/hosts
...
gobuster dir -u http://${DIR_NAME}.thm -w /usr/share/seclists-git/Discovery/Web-Content/directory-list-2.3-medium.txt -t 64 -o scans/${DIR_NAME}_GoBuster_scan.txt &>/dev/null
wait
